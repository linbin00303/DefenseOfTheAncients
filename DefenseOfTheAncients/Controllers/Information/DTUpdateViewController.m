...
@implementation DTUpdateViewController
...
- (void)requestDataSource {
    ...
    [[DTApiManager sharedApiManager] requestInformationForUpdateWithPageIndex:self.pageIndex
        SuccBlocks:^(NSArray *UpdateItems) {
          if (self.pageIndex == 1) {
              [self.dataSource removeAllObjects];
          }
          [self.dataSource addObjectsFromArray:UpdateItems];
